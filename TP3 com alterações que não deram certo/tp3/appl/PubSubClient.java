...
public class PubSubClient {
    ...
    public void subscribe(Host primary) {
        ...
        try{
            ...
            if (response != null && response.getType().equals("backup")) {
                primary.address = response.getContent().split(":")[0];
                primary.port = Integer.parseInt(response.getContent().split(":")[1]);
            ...
            if (this.brokers != null){
                ...
                do{
                    ...
                    primary.address = starter.split(":")[0];
                    primary.port = Integer.parseInt(starter.split(":")[1]);            
                   
                    msgElection.setBrokerId(primary.port);
    ...
    */
     ...
     * @param brokerPort     - The broker port.
    */
    public void publish(String message, Host primary) {
        Message msgPub = new MessageImpl();
        msgPub.setBrokerId(primary.port);
        msgPub.setType("pub");
        msgPub.setContent(message);
        Client publisher = null;
        Message response = null;
        System.out.println ("HOST: " + primary.port);

        publisher = new Client(primary.address, primary.port); 
        ...
        try{
            ...
            // Print an error to find out which backup is failing
            System.out.println("Error on broker (" + primary.address + ":" + primary.port + ")" + e);
        }
                ...
                if(responseElection.getType().equals("primarySynced")){
                    ...
                    try{
                        ...
                        if(responseElection != null){
                            ...
                            System.out.println ("NEW HOST: " + primary.port);
    ...
    public void startConsole() {
        ...
        Host broker = new Host(brokerAddress, brokerPort);
